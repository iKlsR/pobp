...
int main (int argc, char * argvs[]) {
...

    {
        ...
        obp_resources.vertex_buffer  = obp_make_buffer(GL_ARRAY_BUFFER, sizeof(obp_cube_vertices), obp_cube_vertices);
        obp_resources.element_buffer = obp_make_buffer(GL_ELEMENT_ARRAY_BUFFER, sizeof(obp_cube_elements), obp_cube_elements);
        obp_resources.texture        = obp_load_image("tex\\crate.png", GL_TEXTURE0);

        {
            ...
            glVertexAttribPointer(uvAttrib, 2, GL_FLOAT, GL_FALSE, 8 * sizeof(GLfloat), (GLvoid *)(6 * sizeof(GLfloat)));
